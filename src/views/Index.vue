<template> 
    <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
        <div class="container">
            <a class="navbar-brand logo-image" href="index.html" style="margin-top:-11px;">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#services">Que hacemos</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid mis_form_images" src="/img/camion.png" alt="alternative">
                      <!--  <img class="img-fluid mis_form_images" src="/img/loading-van.png" alt="alternative"> 468 * 622 camion -->
    ...
    <div id="details" class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid images_details" src="https://www.ekko-wp.com/static/wp-content/uploads/sites/3/2019/03/moving9.jpg" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
    ...
    <div class="basic-2">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid images_details2" src="https://www.ekko-wp.com/static/wp-content/uploads/sites/3/2019/03/moving8.jpg" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="https://www.ekko-wp.com/static/wp-content/uploads/sites/3/2019/03/moving8.jpg" alt="alternative">
                        <div class="card-body">
